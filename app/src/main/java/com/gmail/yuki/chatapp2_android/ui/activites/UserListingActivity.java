...
import com.gmail.yuki.chatapp2_android.core.logout.LogoutPresenter;
import com.gmail.yuki.chatapp2_android.ui.adapters.UserListingPagerAdapter;
...
public class UserListingActivity extends AppCompatActivity implements LogoutContract.View {
    ...
    //LogoutContract.Viewをimplementsして、Overrideして使う////////////////////////////////////

    //起動されるAcitivityより前のスタックのAcitvityをクリアして起動させる
    @Override
    public void onLogoutSuccess(String message) {
        Toast.makeText(this, message, Toast.LENGTH_SHORT).show();
        ChooseActivity.startIntent(this,
